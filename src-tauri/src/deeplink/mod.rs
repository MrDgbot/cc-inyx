//! Deep link import functionality for Inyx
//!
//! This module implements the ccinyx:// protocol for importing configurations
...
///
/// Represents a parsed ccinyx:// URL ready for processing.
