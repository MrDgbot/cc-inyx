...
//!
//! Parses ccinyx:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ccinyx:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ccinyx://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ccinyx" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ccinyx', got '{scheme}'"
        )));
    }
